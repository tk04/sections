...
const nextConfig = {
  ...
  env: {
    ...
    TWITTER_URI:
      "https://twitter.com/i/oauth2/authorize?response_type=code&client_id=TkZvYWJ2QkdaUW9FYlZjYmtSTTM6MTpjaQ&redirect_uri=http://localhost:3000/twitter_cb&scope=tweet.read%20users.read%20follows.read&state=state&code_challenge=challenge&code_challenge_method=plain",
  },
};
